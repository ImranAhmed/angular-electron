...
describe('LoggingService', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [{ provide: HttpXhrBackend, useClass: HttpBackend }, LoggingService],
    ...
    const logLevelTests = (level: string): void => {
        describe(level.toLowerCase(), () => {
            ...
            it('should call the logger with the correct method', inject([LoggingService], (service: LoggingService) => {
                // Arrange
            ...
            it('should call the logger with the correct message when message of type string', inject(
                [LoggingService],
            ...
            it('should call the logger with the correct message when message of type object', inject(
                [LoggingService],
                (service: LoggingService) => {
                    // Arrange
                    ...
                    expect(logSpy).toHaveBeenCalledWith(
                        `LoggingTest: ${JSON.stringify(additionalInfo)}${commonLogMessage}`
                    );
                }
            ));

            it('should call the logger with the name of the object instance', inject(
                [LoggingService],
                (service: LoggingService) => {
                    // Arrange
                    const logSpy = spyOn(window.console, method).and.stub();
